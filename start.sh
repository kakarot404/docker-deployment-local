...
echo "🛠 Building backend image now, Thank Y0u for your patience"
cd ./Pools-App-Backend || { echo "❌ Backend directory not found!"; exit 1; }
...
cd ../Pools-App-Frontend || { echo "❌ Frontend directory not found!"; exit 1; }
...
sleep 5
echo "✅ All services started. Open http://localhost:4200 in your browser!"